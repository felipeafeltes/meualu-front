(function () {
    ...
    function ScheduledControllerLandlord($scope, ScheduledCancel, mySelfVisitsLandlord, ScheduleCancelJustificationsL, ScheduledAccept) {
        $scope.properties = [];
    ...
    function ScheduledControllerRenter($scope, mySelfVisitsRenter, ScheduleCancelJustificationsR, ScheduledCancel) {
        $scope.properties = [];
        $scope.justifications = [];
        $scope.cancelReason;
        $scope.idToCancel;
